...
public class MalusSlowView extends AbstractEntityView {
    private static final String MALUS_SLOW_PATH = "/slow.png";
    private final SpriteSheet ss = new SpriteSheet(MALUS_SLOW_PATH);
     ...
     */
    public MalusSlowView(final Position position, final Dimension dimension, final boolean visible) {
